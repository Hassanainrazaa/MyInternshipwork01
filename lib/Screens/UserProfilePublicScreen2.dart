...
import 'package:speedforcetasks/Screens/UserProfileScreen3.dart';

class UserProfilePublicScreen2 extends StatefulWidget {
  const UserProfilePublicScreen2({Key? key}) : super(key: key);

  @override
  State<UserProfilePublicScreen2> createState() =>
      _UserProfilePublicScreen2State();
}

class _UserProfilePublicScreen2State extends State<UserProfilePublicScreen2> {
  @override
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const UserProfilePublicScreen03()),
                    );
                  },
                  child: Container(
